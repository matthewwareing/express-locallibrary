...
exports.author_create_post = [
    ...
    body('family_name').isLength({ min: 1 }).trim().withMessage('Fam').isAlphanumeric().withMessage('Family name must be specified.'),
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            // There are errors. Render form again with sanitized values/error messsages.
